...
public class WorkflowServiceImpl implements IWorkflowService {
	...
	/**更新请假状态，启动流程实例，让启动的流程实例管理业务*/
	@Override
	public void saveStartProcess(WorkflowBean workflowBean) {
		//1: 获取请假单ID，使用请假单ID，查询请假单的对象LeaveBill
		Long id = workflowBean.getId();
		LeaveBill leaveBill = leaveBillDao.findLeaveBillById(id);
		//2：更新请假单的请假状态从０变成１，（初始录入－－＞审核中）
...
//		String processInstanceId = hpi.getId();
		...
		HistoricVariableInstance hvi = historyService.createHistoricVariableInstanceQuery()//对应历史 的流程变量表
	...
	@Override
	public void saveStartProcess2(WorkflowBean workflowBean) {
		//1: 获取请假单ID，使用请假单ID，查询请假单的对象LeaveBill
		Long id = workflowBean.getId();
		LeaveBill leaveBill = leaveBillDao.findLeaveBillById(id);
		//2：更新请假单的请假状态从０变成１，（初始录入－－＞审核中）
		...
		//任务ID
		String taskId = list.get(list.size()-1).getId();
	...
	@Override
	public void saveSubmitTask2(String taskId) {
		Task task = taskService.createTaskQuery()//
				.taskId(taskId)//使用任务ID查询
				.singleResult();
		//获取流程实例ID
