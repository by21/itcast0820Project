...
public class WorkflowAction extends ActionSupport implements ModelDriven<WorkflowBean> {
	...
	public String startProcess2(){
		workflowService.saveStartProcess2(workflowBean);
		/*
...
//		workflowService.saveSubmitTask2(taskId);
	...
	public String viewHisComment(){
		...
		ValueContext.putValueStack(leaveBill);
		//2: 使用请假单ID，查询历史的批注信息
		List<Comment> commenList = workflowService.findCommentByLeaveBillId(id);
		ValueContext.putValueContext("commentList", commenList);
