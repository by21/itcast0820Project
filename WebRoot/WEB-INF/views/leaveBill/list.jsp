		  ...
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      <tr>
		        ...
		        <td width="8%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">请假人</span></div></td>
		        <td width="6%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">开始时间</span></div></td>
		        <td width="6%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">结束时间</span></div></td>
		      ...
		      <s:if test="#list!=null && #list.size()>0">
		      	<s:iterator value="#list">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><s:date name="startTime" format="yyyy-MM-dd"/></div></td>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><s:date name="endTime" format="yyyy-MM-dd"/></div></td>
				        ...
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
					        <s:if test="state==0">
								...
								<a href="${pageContext.request.contextPath }/workflowAction_startProcess2.action?id=<s:property value="id"/>" >申请请假</a>
						    </s:if>
					        <s:elseif test="state==1">
